...
-(void)doneClick
{
    if (_pickerView) {
        ...
        _resultString_date=_datePicker.date;
    ...
    if ([self.delegate respondsToSelector:@selector(date:resultString_date: )]) {
        [self.delegate date:self resultString_date:_resultString_date ];
    }
   // if ([self.delegate respondsToSelector:@selector(date:resultString_date:)]){
   //     [self.delegate date:self resultString_date:_resultString_date];
   // }
